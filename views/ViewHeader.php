<header id="header">
  ...
  <div class="container top-header">
    <div class="row">
      ...
      <div class="col-6 ty-wysiwyg-content contact" data-ca-live-editor-object-id="0" data-ca-live-editor-object-type="">
        <p style="margin: 0;padding: 0;margin-top: 4px;" class="text-right"><span style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); white-space: nowrap; color: rgb(204, 0, 0); font-family: Arial, Helvetica, sans-serif, sans-serif; font-size: 17px; font-weight: 700; margin: 0;"><i class="fas fa-phone-alt"></i> 1900-6656</span></p>
    ...
    <div class="row">
      <div class="col-8 form-search">
        ...
        <div style="margin-top:25px; position:relative;" class="search">
          <!-- <input type="search" onkeypress="searchForm(event);" value="" placeholder="Tìm kiếm sản phẩm" id="key" class="input-control">
          <button style="margin-top:5px;" type="submit"> <i class="fa fa-search" onclick="return search();"></i>
          </button> -->
          <input type="search" name="" id="key" placeholder="Search..." class="input-control">
          <div class="smart-search">
            <ul>
              <li><img src="http://localhost/BTL_CongCu/assets/upload/products/<?php echo $rows->photo; ?>" alt=""><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><?php echo $rows->name; ?></a></li>
              <li><img src="http://localhost/BTL_CongCu/assets/upload/products/<?php echo $rows->photo; ?>" alt=""><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><?php echo $rows->name; ?></a></li>
              <li><img src="http://localhost/BTL_CongCu/assets/upload/products/<?php echo $rows->photo; ?>" alt=""><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><?php echo $rows->name; ?></a></li>
              <li><img src="http://localhost/BTL_CongCu/assets/upload/products/<?php echo $rows->photo; ?>" alt=""><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><?php echo $rows->name; ?></a></li>
            </ul>
