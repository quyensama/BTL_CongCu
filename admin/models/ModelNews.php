<?php 
	trait ModelNews{
		...
		public function modelUpdate(){
			...
			$query->execute(array("var_name"=>$name, "var_content"=>$content, "var_hot"=>$hot, "var_description"=>$description));			
			//-------
			// nếu user upload ảnh thì thực hiện upload
			$photo = "";
		...
		public function modelCreate(){
			...
			$query->execute(array("var_name"=>$name, "var_content"=>$content, "var_hot"=>$hot, "var_description"=>$description, "var_photo"=>$photo));			
			//-------
		}
