...
trait ModelProducts
{
	...
	public function modelUpdate()
	{
		...
		//lay bien ket noi csdl
		$conn = Connection::getInstance();
		$query = $conn->prepare("update products set name=:var_name,category_id=:var_category_id, discount=:var_discount,price=:var_price,description=:var_description_,content=:var_content_,hot=:var_hot where id=$id");
		$query->execute(array("var_name" => $name, "var_category_id" => $category_id, "var_discount" => $discount, "var_price" => $price, "var_description_" => $description, "var_content_" => $content, "var_hot" => $hot));
		//---
	...
	public function modelCreate()
	{
		...
		//lay bien ket noi csdl
		$conn = Connection::getInstance();
		$query = $conn->prepare("insert products set name=:var_name,category_id=:var_category_id, discount=:var_discount,price=:var_price,description=:var_description_,content=:var_content_,hot=:var_hot,photo=:var_photo");
		$query->execute(array("var_name" => $name, "var_category_id" => $category_id, "var_discount" => $discount, "var_price" => $price, "var_description_" => $description, "var_content_" => $content, "var_hot" => $hot, "var_photo" => $photo));
		//---
	}
